    ...
    <div className='min-h-screen flex items-center justify-center bg-gray-100 px-4'>
      ...
      {step == 1 && <div className='bg-white shadow-md rounded-xl p-8 max-w-md w-full'>
        ...
        <form className='space-y-4' onSubmit={(e) => e.preventDefault()}>
          ...
          <button className='w-full bg-black hover:bg-[#4b4b4b] text-white px-4 py-2 rounded-md font-medium cursor-pointer'
            disabled={loading}
            onClick={sendOtp}>
      ...
      {step == 2 && <div className='bg-white shadow-md rounded-xl p-8 max-w-md w-full'>
        ...
        <form className='space-y-4' onSubmit={(e) => e.preventDefault()}>
          <div>
            <label htmlFor="otp" className='block text-sm font-medium text-gray-700'>Please enter your 4-digit code sent on your email</label>
          ...
          <button className='w-full bg-black hover:bg-[#4b4b4b] text-white px-4 py-2 rounded-md font-medium cursor-pointer' disabled={loading} onClick={verifyOtp}>
      ...
      {step == 3 && <div className='bg-white shadow-md rounded-xl p-8 max-w-md w-full'>
        ...
        <form className='space-y-4' onSubmit={(e) => e.preventDefault()}>
          ...
          <button className='w-full bg-black hover:bg-[#4b4b4b] text-white px-4 py-2 rounded-md font-medium cursor-pointer' disabled={loading} onClick={resetPassword}>
