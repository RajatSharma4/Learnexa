      ...
      <div className='w-full min-h-screen p-4 sm:p-6 bg-gray-100'>
        ...
        <div className='flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 gap-3'>
          ...
          <div className='flex items-center justify-center gap-3'>
            <FaArrowLeft className='w-5.5 h-5.5 cursor-pointer' onClick={() => navigate("/dashboard")} />
            <h1 className='text-2xl font-semibold'>All Created Courses</h1>
          </div>

          <button className='bg-black text-white px-4 py-2 rounded hover:bg-gray-700 cursor-pointer' onClick={() => navigate("/createcourse")}>Create Course</button>
        ...
        <div className='hidden md:block bg-white rounded-xl shadow p-4 overflow-x-auto'>
          <table className='min-w-full text-sm'>
            ...
            <tbody className='border-b hover:bg-gray-50 transition duration-200'>
            ...
            <div key={index} className='bg-white rounded-lg shadow p-4 flex flex-col gap-3'>
              <div className='flex gap-4 items-center'>
                ...
                <div className='flex-1'>
                  <h2 className='font-medium text-small'>{course.title}</h2>
              ...
              ${course?.isPublished ? "text-green-600 bg-green-100" :
