            ...
            <div className='w-full md:w-2/3 bg-white rounded-2xl shadow-md p-6 border border-gray-200'>
              <div className='mb-6'>
                 <h2 className='text-2xl font-bold flex items-center justify-start gap-5 text-gray-800'>
                   <FaArrowLeft className='text-black w-5.5 h-5.5 cursor-pointer' onClick={()=>navigate("/")}/> {selectedCourse?.title}</h2>
              ...
              <div className='mt-2'>
                <h2 className='font-semibold text-xl text-gray-800'>{selectedLecture?.lectureTitle}</h2>
              </div>
            </div>
